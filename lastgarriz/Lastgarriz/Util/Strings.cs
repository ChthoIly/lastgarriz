...
namespace Run.Util
{
    ...
    internal static class Strings
    {
        ...
        internal static class Feature
        {
            ...
            internal const string ARTILLERY_UK = "artillery_uk";
            ...
            internal static readonly List<string> Unregisterable = new() { ARTILLERY_USGER, ARTILLERY_RU, ARTILLERY_UK, AUTOQUEUE }; // BROWSER
        }
